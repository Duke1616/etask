...
const file_policy_v1_policy_proto_rawDesc = "" +
	...
	"\rPolicyService\x129\n" +
	"\tAuthorize\x12\x17.policy.v1.AuthorizeReq\x1a\x13.policy.v1.ResponseB\xa4\x01\n" +
	"\rcom.policy.v1B\vPolicyProtoP\x01ZAgithub.com/Duke1616/ework-runner/api/proto/gen/policy/v1;policyv1\xa2\x02\x03PXX\xaa\x02\tPolicy.V1\xca\x02\tPolicy\\V1\xe2\x02\x15Policy\\V1\\GPBMetadata\xea\x02\n" +
