...
func (c *executorServiceClient) Interrupt(ctx context.Context, in *InterruptRequest, opts ...grpc.CallOption) (*InterruptResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExecutorService_Interrupt_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *executorServiceClient) Query(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (*QueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, ExecutorService_Query_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentServiceClient) PullTask(ctx context.Context, in *PullTaskRequest, opts ...grpc.CallOption) (*PullTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, AgentService_PullTask_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskExecutionServiceClient) ListTaskExecutions(ctx context.Context, in *ListTaskExecutionsRequest, opts ...grpc.CallOption) (*ListTaskExecutionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskExecutionService_ListTaskExecutions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskExecutionServiceClient) GetExecutionLogs(ctx context.Context, in *GetExecutionLogsRequest, opts ...grpc.CallOption) (*GetExecutionLogsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskExecutionService_GetExecutionLogs_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *taskExecutionServiceClient) BatchListTaskExecutions(ctx context.Context, in *BatchListTaskExecutionsRequest, opts ...grpc.CallOption) (*BatchListTaskExecutionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TaskExecutionService_BatchListTaskExecutions_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTaskExecutionServiceServer) BatchListTaskExecutions(context.Context, *BatchListTaskExecutionsRequest) (*BatchListTaskExecutionsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BatchListTaskExecutions not implemented")
}
