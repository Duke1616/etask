...
func InitSchedulerApplication(base *Base) *SchedulerApplication {
	...
	iClusterKeyManager := InitClusterKeyManager(universalClient)
	clients := InitExecutorServiceGRPCClients(registry, iClusterKeyManager)
	...
	server := InitSchedulerNodeGRPCServer(registry, reporterServer, taskServer, agentServer, codebookServer, runnerServer, artifactServer, schedulerServer, iClusterKeyManager)
